...
export const Basket =(props:Props)=>{
    ...
    function delete_all_from_basket(){
        dispatch({type:"change_basket_blank"}),
        dispatch({type:"delete_all"}),
        dispatch({type:"set_null_pcs"}),
        dispatch({type:"reset_price"})
    }
    return (
        <>
            <Header title={'самая вкусная пицца'}></Header>
            <div className={s.basket}>
                <div className={s.body}>
                    <div className={s.wrapper}>
                        <div className={s.wrapper_item_basket_logo}>
                        ...
                        <button className={s.wrapper_item_basket_button_clear} onClick={()=>delete_all_from_basket()}>
                            <div className={s.logo}>
                            ...
                            <div className={s.text}>Очистить корзину</div>
                        </button>


                    </div>
                    <div className={s.pizza_list}>
                        {pizza.map(product=> <Product_in_basket product={product} key={product.id}/>)}
                    </div>
                    <div className={s.wrapper}></div>
                    <div className={s.wrapper}>
                        <button >
                            <div className={s.wrapper_item_basket_button_back}>
                                ...
                                <Link to={`/`}><div className={s.text}>Вернуться назад</div></Link>
                                {/*<div className={s.text}>Вернуться назад</div>*/}
                            </div>
                        </button>
                        <button className={s.wrapper_item_basket_button_buy}>
                            <div className={s.text}>Оплатить сейчас</div>
                        </button>
                    </div>
                </div>
            </div>
